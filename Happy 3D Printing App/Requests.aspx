<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Requests.aspx.cs" Inherits="Happy_3D_Printing_App.Requests" %>
...
<body>
  ...
  <a href="Home.aspx">Home</a>
   <a class="active" href="Requests.aspx">Customer Requests</a>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Image">
            ...
            <asp:Button ID="Button1" runat="server" Text="Reply to Customer" OnClick="Button1_Click" />
        </div>
