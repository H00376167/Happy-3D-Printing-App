<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerRegistration.aspx.cs" Inherits="Happy_3D_Printing_App.CustomerRegistration" %>
...
<head runat="server">
    ...
    <title>Happy 3D Printing App - Customer Registration</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        .registration-container {
            ...
            margin: auto;
            margin-top: 100px;
            background-color: #ffffff; /* Light background color for registration area */
            padding: 20px;
            border-radius: 8px;
